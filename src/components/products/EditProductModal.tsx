      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 border-t flex justify-end gap-3 bg-white shrink-0">
          ...
          <button 
            ...
            className="px-6 py-2.5 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 disabled:opacity-50 transition-colors flex items-center justify-center gap-1 min-w-[140px]"
          >
            {loading ? <Loader size={30} /> : 'Save Changes'}
          </button>
        </div>
      </div>
    </div>
