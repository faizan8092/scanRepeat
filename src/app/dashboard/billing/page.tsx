              ...
              <div className="relative z-10">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                  <div>
                    ...
                    <h2 className="text-4xl font-black text-foreground tracking-tight mb-2">Growth Plan</h2>
                    <p className="text-muted-foreground font-bold text-sm">Efficiently scaling your brand experiences.</p>
                  </div>
                  <div className="text-left md:text-right">
                    <div className="text-4xl font-black text-foreground tracking-tight mb-1">$29<span className="text-lg text-muted-foreground">/mo</span></div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <button className="w-full sm:w-auto px-10 py-4 rounded-2xl bg-foreground text-background hover:bg-primary transition-all shadow-xl">
                    Change Plan
                  </button>
